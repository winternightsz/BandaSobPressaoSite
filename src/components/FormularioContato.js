const FormularioContato = () => {
    return (
      <div className="mt-8 w-full bg-blue-600 p-6 rounded-lg shadow-md max-w-4xl mx-auto">
        <form className="flex flex-col md:flex-row justify-between gap-4">
          ...
          <div className="flex flex-col w-full md:w-1/2">
            ...
            <button
              type="submit"
              className="mt-4 p-2 bg-blue-500 text-white rounded hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-300"
            >
              Enviar
            </button>
          </div>
