    ...
    return (
      <div className="flex flex-col md:flex-row items-center justify-between p-4">
        ...
        <div className="flex flex-col items-center md:items-end mt-4 md:mt-0 md:w-1/2">
          <h1 className="text-3xl font-bold mb-4">Nos contate para agendar um horário!</h1>
          <a href="#" className="bg-blue-500 text-white px-4 py-2 rounded-lg shadow hover:bg-blue-600 w-full md:w-auto text-center">Botão</a>
        </div>
      </div>
    );
  };
